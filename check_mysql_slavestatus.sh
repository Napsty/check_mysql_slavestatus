...
#########################################################################
while getopts "H:P:u:p:s:w:c:o:h" Input;
do
	case ${Input} in
	H)	host="-h ${OPTARG}";;
	P)	port="-P ${OPTARG}";;
